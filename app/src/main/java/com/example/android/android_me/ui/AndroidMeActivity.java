...
public class AndroidMeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            int head= bundle.getInt("headIndex");
            int body=bundle.getInt("bodyIndex");
            int leg=bundle.getInt("legIndex");
            ...
            fragmentManager.beginTransaction().add(R.id.head_container, headFragment).add(R.id.body_container, bodyPartFragment).add(R.id.leg_container, legPartFragment).commit();
        }
    }
}
